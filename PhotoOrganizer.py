...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        self.results = {}
        self.btns = []
        self.desk = os.path.join(os.environ["HOMEPATH"], "Desktop")
    ...
    def sortFiles(self):
        try:
            if self.files_path and self.btns:
                ...
                try:
                    os.mkdir(self.desk + "\\Output")
                except:
                    pass
                os.chdir(self.desk + "\\Output\\")
            ...
            QtWidgets.QMessageBox.critical(self, "Error", str(err) + self.desk)
